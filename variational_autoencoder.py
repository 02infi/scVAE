...
matrix_dir= "/home/gaurav/Gaurav/Berlin/Deep Learning/data/matrix.mtx"
L2 = scipy.io.mmread(matrix_dir)
Genes = scipy.genfromtxt('/home/gaurav/Gaurav/Berlin/Deep Learning/data/genes.tsv',delimiter="\t",dtype= str )
Cells = scipy.genfromtxt('/home/gaurav/Gaurav/Berlin/Deep Learning/data/barcodes.tsv',delimiter="\t",dtype= str)
...
vae.fit(training_data,epochs=epochs,batch_size=batch_size,callbacks=[TensorBoard(log_dir='/tmp/autoencoder')])
...
def Encoder():
    ...
    z_mean = Dense(latent_dim, kernel_initializer= keras.initializers.glorot_normal(),name='z_mean')(Hidden_1)
    z_log_var = Dense(latent_dim,kernel_initializer= keras.initializers.glorot_normal(), name='z_log_var')(Hidden_1)
...
def Decoder():
    ...
    Hidden_2 = Dense(intermediate_dim, kernel_initializer= keras.initializers.glorot_normal(), activation='relu')(Hidden_2)
...
def Create_Network():
    ...
    reconstructed_vector = Decoder(latent_inputs)
    # instantiate VAE model
    outputs = decoder(encoder(inputs)[2])
    vae = Model(inputs, outputs, name='vae_mlp')
